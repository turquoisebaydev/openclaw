...
describe("handleToolExecutionStart observability summaries", () => {
  it("emits raw command in argsSummary without commandPreview (preview shaping is plugin-side)", async () => {
    ...
    // commandPreview is no longer generated by core; hive plugin handles shaping via stripLeadingEnvVars
    expect(argsSummary.commandPreview).toBeUndefined();
