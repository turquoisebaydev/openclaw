...
const ENUM_EXPECTATIONS: Record<string, string[]> = {
  ...
  "observability.events.capture.prompts": ['"off"', '"summary"', '"full"'],
  "observability.events.capture.toolArgs": ['"off"', '"summary"', '"full"'],
  "observability.events.capture.toolResults": ['"off"', '"summary"', '"full"'],
  "observability.events.capture.filePaths": ['"off"', '"summary"', '"full"'],
  "observability.events.capture.commands": ['"off"', '"summary"', '"full"'],
  "observability.events.capture.webQueries": ['"off"', '"summary"', '"full"'],
  "observability.logs.format": ['"tail"', '"json"'],
